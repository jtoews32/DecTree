//
//  DecisionStartTableController.swift
//  DecTree
//
...
class DecisionStartTableController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if (indexPath.row == 0)
        {
            let decisionController: DecisionScrollController = DecisionScrollController()
